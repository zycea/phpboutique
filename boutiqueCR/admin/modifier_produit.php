...
// recuperer les infos du produit selectionne
...
<body>
  ...
  <div class="container product-form">
    <form class="row g-3" method="post" action="traitement_admin.php" enctype="multipart/form-data">
      <!-- titre -->
      <input type="text" name="id" value="<?= $produit['id_produit'] ?>" hidden>
      <div class="col-md-12">
      ...
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" name="old-image" value="<?= $produit['url_image'] ?>" hidden>
      </div>
      <div class="col-md-6">
        <label for="inputCity" class="form-label">Reduction</label>
        <input type="number" class="form-control" name="reduction" value="<?= $produit['reduction'] ?>">
      </div>
      <!-- bouton valider -->
      <div class="col-12">
        <button name="modifier" class="btn btn-primary">Modifer</button>
      </div>
    </form>
  </div>
</body>
